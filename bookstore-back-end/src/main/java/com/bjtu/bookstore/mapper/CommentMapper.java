...
public interface CommentMapper {
    ...
    ArrayList<Comment> getCommentByBook(String bookId);
    //    获取某一个订单的所有评论
    ...
    int sendComment(String commentId, String userId, String bookId, String orderId, String comment, Date date, int rate);
}
