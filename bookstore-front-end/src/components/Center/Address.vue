  ...
  <div>
    ...
    <el-dialog title="收货地址" :visible.sync="addVisible">
      <el-form :model="addAddressForm">
        ...
        <el-form-item label="收件人">
          <el-input
            v-model="addAddressForm.consigneeName"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="联系方式">
    ...
    <el-row>
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column fixed prop="address" label="地址" width="500">
        </el-table-column>
        <!--       <el-table-column-->
        <!--           prop="addressId"-->
        <!--           label="编号"-->
        ...
        <el-table-column label="操作" width="130">
          <template slot-scope="scope">
            <el-button @click="modifyAddr(scope.row.addressId)" type="text"
              >修改</el-button
            >
            <el-button
              @click="openDelDialog(scope.row.addressId)"
              type="text"
              style="color: red"
              >删除</el-button
            >
